...
<caption>총 <%=cnt %>개의 상품정보가 있습니다.</caption>	
	...
	<%
		sql="select a.productcode,a.productname,a.storecode,b.storename,to_char(unitprice,'999,999,999'),stockqty from product0325 a,store0325 b where a.storecode=b.storecode order by a.productcode";
		pstmt=conn.prepareStatement(sql);
		rs=pstmt.executeQuery();
		int n=0;
